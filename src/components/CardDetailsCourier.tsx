...
const CardDetailsCourier = () => {
  return (
    <>
      ...
      <span className='absolute w-[60px] h-[15px] top-[316px] left-[227px] text-[14px] leading-[15px] font-normal text-[#3D1DF3] z-40'>
        03/01/23
      </span>
      ...
      <span className='absolute w-[21px] h-[20px] top-[395px] left-[264px] font-normal text-[#3D1DF3] leading-[25px] text-[12px] z-50'>
        Ver
      </span>
      ...
      <span className='absolute w-[21px] h-[20px] top-[500px] left-[264px] font-normal text-[#3D1DF3] leading-[25px] text-[12px] z-50'>
        Ver
      </span>
      ...
      <button
        ...
        type='submit'
      ></button>
      <span className='absolute w-[93px] h-[15px] top-[574px] left-[125px] font-normal text-[#3D1DF3] text-[12px] leading-[15px] whitespace-nowrap z-40'>
        Nuevo paquete
      </span>
      <Image
        src={iconPlus}
