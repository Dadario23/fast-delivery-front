...
const ResetPassword: React.FC = ({params}) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await mailResetPassword(params.token, formData.password);
  ...
  return (
    <>
      ...
      >
        ...
        <p className=" absolute text-[12px] top-[370px]">Ingresá tu nueva contraseña.</p>
      </form>
    </>
  );
};
...
//         className="flex flex-col items-center relative"
//       >
//         <div className="absolute mb-4 top-[320px] left-[30px]">
//           <span className="absolute inset-y-0 left-0 pl-3 flex items-center">
//             <Image src={passIcon} alt="pass icon" width={14} height={16} />
//           </span>
//           <input
