...
const StartWorkingDay: React.FC<{
	...
	return (
		<div className="flex flex-col w-full h-screen mt-[-2px] p-6 pt-2 items-center bg-customBlue text-customBlue">
			{' '}
			{/*container */}
			<div className="flex bg-white text-indigo-700 w-full m-4 mb-2 p-4 flex-col rounded-[10px]">
				{' '}
				{/*subContainer */}
				<div className="flex items-center justify-between pl-1 pr-1">
					{/*header */}
          ...
          showReps &&
          reps.map((rep) => (
          	<div className="mt-4 mr-0 flex p-3 pr-0 w-full h-24 rounded-2xl border border border-indigo-400 justify-between"
          		key={rep.id}
          	>
          		{' '}
          		{/*box*/}
			...
			{/*===================================== */}
			<div className="flex bg-white text-indigo-700 w-full mt-[8px] p-4 flex-col rounded-[10px]">
				<div className="flex items-center justify-between pl-1 pr-1 ">
					<h2 className="font-bold">
            Historial de repartos ({repsHistory.length})
					</h2>
          ...
          repsHistory.map((rep) => (
			...
			<div className="flex justify-center items-center w-full h-12 pt-2">
				<div
					style={{ backgroundColor: '#00ea77' }}
					className="flex items-center justify-center p-2 h-[30px] w-[270px] text-[14px] text-indigo-700 rounded-[15px] transition-all duration-200 ease-in-out active:bg-green-600"
				>
					<h2 className="">Obtener Paquetes</h2>
				</div>
			</div>
