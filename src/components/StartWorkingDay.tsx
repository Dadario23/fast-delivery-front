...
const StartWorkingDay: React.FC = () => {
	...
	//       </div>
	//       {isExpanded1 && (
	//         <div className="overflow-x-hidden max-h-[221px] pr-4">
	...
	//             .map((packageItem, index) => (
	//               <div
	//                 className="relative border border-[#8976F8] h-[80px] w-[270px] ml-[15px] mb-[10px] top-[10px] rounded-[10px] transition-all duration-300 ease-in-out"
	//                 key={index}
	//               >
	//                 <div
	//                   className={`absolute text-[#3d1df3] rounded-l-[15px] text-center text-[10px] w-[70px] font-semibold ml-[198px] mt-[10px] ${
